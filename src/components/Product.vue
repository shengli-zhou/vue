      ...
      <div class="sou">
        ...
        <span class="fr">
          <span class="fl" v-if="name==null">你好,请<router-link  to="/Login">登录</router-link>&nbsp; <a href=" " style="color:#ff4e00;">免费注册</a>&nbsp;&nbsp;</span>
        	<span class="fl">
            <div class="ss_list"><router-link  to="/Member_User">{{name}}</router-link>
                    ...
                    <div class="ss_list_bg">
                        ...
                        <div class="ss_list_c">
                            ...
                            <li><a href="#/Index">首页</a></li>
                            	<li><a href="#/Member_User">个人中心</a></li>
    ...
    <div class="top">
      ...
      <div class="i_car">
        <router-link :to="'/Buycart'">
          <div class="car_t"><router-link :to="'/Buycart'"><a>我的购物车</a></router-link></div>
        </router-link>
      </div>
    </div>
    <!--End Header End-->
    ...
    <div class="i_bg">
      ...
      <div class="content">
        ...
        <div id="tsShopContainer">
          <div id="tsImgS"><a href="../assets/images/p_big.jpg" title="../assets/images" class="MagicZoom" id="MagicZoom"><img src="../assets/images/p_big.jpg" width="390" height="390" /></a></div>
        ...
        <div class="pro_des" >
          ...
          <div class="des_choice" v-for="(value,key) in res.data">
            ...
            <label>
            <span v-for="name in value">
            <input type="radio" v-bind:value="name[1]" v-bind:name="key" v-on:click="radio">{{name[0]}}
              </span>
            </label>
          </div>
      ...
      <div class="content mar_20">
        ...
        <div class="l_list">
          <div class="des_border">
            ...
            <div class="team_list">
              <div class="img"><a href="#"><img src="../assets/images/mat_1.jpg" width="160" height="140" /></a></div>
            ...
            <div class="team_icon"><img src="../assets/images/jia_b.gif" /></div>
            <div class="team_list">
              <div class="img"><a href="#"><img src="../assets/images/mat_2.jpg" width="160" height="140" /></a></div>
            ...
            <div class="team_icon"><img src="../assets/images/jia_b.gif" /></div>
            <div class="team_list">
              <div class="img"><a href="#"><img src="../assets/images/mat_3.jpg" width="160" height="140" /></a></div>
              <div class="name"><a href="#">香奈儿邂逅清新淡香水50ml</a></div>
              <div class="price">
                <div class="checkbox"><input type="checkbox" name="zuhe" checked="checked" /></div>
                <font>￥<span>749.00</span></font> &nbsp; 18R
            ...
            <div class="team_icon"><img src="../assets/images/equl.gif" /></div>
            <div class="team_sum">
              套餐价：￥<span>1517</span><br />
              <input type="text" value="1" class="sum_ipt" /><br />
              <a href="#"><img src="../assets/images/z_buy.gif" /></a>
            </div>
          ...
          <div class="des_border" id="p_details">
            ...
            <div class="des_con">
              <table border="0" align="center" style="width:745px; font-size:14px; font-family:'宋体';" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="265"><img src="../assets/images/de1.jpg" width="206" height="412" /></td>
                  <td>
                    <b>迪奥真我香水(Q版)</b><br />
                    【商品规格】：5ml<br />
                    【商品质地】：液体<br />
              ...
              <p align="center">
                <img src="../assets/images/de2.jpg" width="746" height="425" /><br /><br />
                <img src="../assets/images/de3.jpg" width="750" height="417" /><br /><br />
                <img src="../assets/images/de4.jpg" width="750" height="409" /><br /><br />
                <img src="../assets/images/de5.jpg" width="750" height="409" />
              </p>
      ...
      <div id="MyDiv1" class="white_content">
        <div class="white_d">
          <div class="notice_t">
            <span class="fr" style="margin-top:10px; cursor:pointer;" onclick="CloseDiv_1('MyDiv1','fade1')"><img src="../assets/images/close.gif" /></span>
          </div>
          <div class="notice_c">
...
<script>
   export default {
                ...
                if (this.isajax==1) {
                  //console.log($("input[name='" + keys + "']:checked").val())
                      $.each(this.res.data,function (keys,value){
                        console.log($("input[name='" + keys + "']:checked").val())
                          _this.attrd_id=_this.attrd_id +"-"+ $("input[name='"+keys+"']:checked").val()
                      })
                      axios.post(this.url+'/findware',{
                          attrd_id:_this.attrd_id,
                          gid:_this.$route.query.gid,
                      })
                          .then(response =>{
     ...
     addcart:function () {
       ...
       axios.post(this.url+'/auth/shopcart',{
         num:num,
         wid:this.mydata.id,
         price:this.mydata.price,
         attrd_id:this.mydata.goods_attr_id,
        ...
        mounted() {
          var gid=this.$route.query['gid']
             console.log(gid)
            axios.get(this.url+'/goods?gid='+gid)
                .then(res=>{
                    console.log(res.data)
                this.res=res.data
                })
