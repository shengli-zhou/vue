      ...
      <div class="m_right">
        <div class="m_des">
          <table border="0" style="width:870px; line-height:22px;" cellspacing="0" cellpadding="0">
            <tr valign="top">
              <td width="115"><img src="../assets/images/user.jpg" width="90" height="90" /></td>
              <td>
                <div class="m_user">{{name}}</div>
                <p>
                  等级：注册用户 <br />
                  <font color="#ff4e00">您还差 270 积分达到 分红100</font><br />
                  上一次登录时间: {{logintime}}<br />
        ...
        <table border="0" class="mon_tab" style="width:870px; margin-bottom:20px;" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="60%">邀请人：<span style="color:#555555;">{{name}}</span></td>
          </tr>
          <tr>
          ...
          <tr>
            <td>身份证号：<span style="color:#555555;">{{identity}}</span></td>
            <td>注册时间：<span style="color:#555555;">{{regtime}}</span></td>
          </tr>
        </table>
