    ...
    <div class="m_content">
      ...
      <div class="m_right">
        ...
        <div class="address">
          ...
          <table border="0" class="add_t" align="center" style="width:98%; margin:10px auto;" cellspacing="0" cellpadding="0" v-for="(value,key) in show">
            <tr>
        ...
        <div class="mem_tit">
          <a v-on:click="add"><img src="../assets/images/add_ad.gif" /></a>
        </div>
        <table border="0" class="add_tab" style="width:930px;"  cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td colspan="3" style="font-family:'宋体';">
              ...
              <select class="jj" id="country2" v-on:change="cy2">
          ...
          <tr>
            ...
            <td style="font-family:'宋体';"><input type="text" id="ws" value="" class="add_ipt" />（必填）</td>
            <td align="right">电子邮箱</td>
            <td style="font-family:'宋体';"><input type="text"  id="yx" value="" class="add_ipt" />（必填）</td>
          </tr>
          <tr>
            <td align="right">详细地址</td>
            <td style="font-family:'宋体';"><input type="text" id="x_address" value="" class="add_ipt" />（必填）</td>
            <td align="right">邮政编码</td>
            <td style="font-family:'宋体';"><input type="text" id="code" value="" class="add_ipt" /></td>
          </tr>
          <tr>
            <td align="right">手机</td>
            <td style="font-family:'宋体';"><input type="text" id="phone" value="" class="add_ipt" />（必填）</td>
            <td align="right">电话</td>
            <td style="font-family:'宋体';"><input type="text"  id="phone_d" value="" class="add_ipt" /></td>
          </tr>
        </table>
        <p align="right">
          <a>删除</a>&nbsp; &nbsp; <a href="#" class="add_b" >确认修改</a>
        </p>
    ...
    export default {
        ...
        methods: {
            cy:function (event) {
                ...
                axios.post(this.url+'/auth/member_address',{
                    p_id:p_id,
            ...
            add(){
                var aa=$("#country option:selected").text();
                console.log(aa)
                var bb=$("#country1 option:selected").text();
                console.log(bb)
                var cc=$("#country2 option:selected").text();
                console.log(cc)
                var name=document.getElementById("ws").value
                var phone=document.getElementById("phone").value
                var x_address=document.getElementById("x_address").value
                var address=aa+"省"+bb+"市"+cc+"(县)"+x_address
                var yx=document.getElementById("yx").value
                var code=document.getElementById("code").value
                var phone_d=document.getElementById("phone_d").value
               console.log(name)
